...
- 名称：`bingxueyizu's blog`
- 描述：`分享技术实践，积累知识沉淀`
- 地址：`https://bingxueyizu.github.io/`
- 头像：`/images/logo/logo.webp`
- 站点图片：`你的站点截图 URL`
- 订阅：`https://bingxueyizu.github.io/rss.xml`

```yml
name: bingxueyizu's blog
desc: 分享技术实践，积累知识沉淀
url: https://bingxueyizu.github.io/
avatar: /images/logo/logo.webp
screenshot: 你的站点截图 URL
rss: https://bingxueyizu.github.io/rss.xml
```

### 申请友链

- 你已添加我的博客 [bingxueyizu's blog](https://bingxueyizu.github.io/) 的友情链接。
