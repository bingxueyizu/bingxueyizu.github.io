...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'bingxueyizu/bingxueyizu.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'bingxueyizu', // 必需
      link: 'https://github.com/bingxueyizu', // 可选的
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          repo: 'bingxueyizu.github.io', // GitHub 仓库
          owner: 'bingxueyizu', // GitHub仓库所有者
          admin: ['bingxueyizu'], // 对仓库有写权限的人
