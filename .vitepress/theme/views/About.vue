  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 冰雪异族</span>
        <span class="text3">是一名 全栈开发工程师、技术博客博主</span>
      </div>
      <!-- 追求 -->
      <div class="about-item pursuit">
        <span class="tip">追求</span>
        <span class="title2">积累知识</span>
        <span class="title2">分享技术</span>
        <span class="title2">共同进步</span>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">全栈开发 · 技术博客博主</span>
          <span class="list-item" style="--color: #eb372a">专注云原生 & CI/CD</span>
        </div>
        <img
          class="career-img"
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item child">
        ...
        >
          <span class="position">我现在住在 <strong>中国</strong></span>
        </div>
        <div class="about-item info">
          <div class="info-item">
            <span class="info-name">博客始于</span>
            <span class="info-num" style="--color: #43a6c6">2019</span>
          </div>
          <div class="info-item">
            <span class="info-name">现在职业</span>
            <span class="info-num" style="--color: #dfac46">全栈开发工程师</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        ...
        <p class="text">
          创建这个博客，就是想要有一个地方能够<strong>积累知识</strong>、<strong>沉淀技术</strong>。把工作和学习中遇到的问题、解决方案记录下来，既是自我总结，也希望能够帮助到其他遇到相同问题的朋友。
        </p>
        <p class="text">
          这里主要分享<strong>云原生、持续集成、环境搭建</strong>等相关技术文章，内容偏向实践教程。如果某篇文章能够帮助到你，那我也会感到很开心。
        </p>
        <p class="text">
          故天将降大任于是人也，必先苦其心志，劳其筋骨，饿其体肤，空伐其身行，行弗乱其所为，所以动心忍性，曾益其所不能。有幸能和你相遇在这里，希望我们能共同进步。
        </p>
      </div>
    </div>
  </div>
